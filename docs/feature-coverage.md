...
| Requirement | State | Implementation and remaining work |
| --- | --- | --- |
| M9-FR-001 — SSO/federation | Gap | Production SSO/federation/SCIM are not implemented. Role preview is explicitly a demo. |
...
| M9-FR-003 — RBAC/ABAC | Partial | Nine roles, capability checks and owner/scope filtering work; general authenticated ABAC remains. |
...
| M9-FR-011 — Multi-tenancy | Partial | Demo tenant/environment stores and owner scope are isolated; production authenticated/distributed isolation remains. |
